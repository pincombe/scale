...
| 2.10 SFX v2: boss horn, tremors, the eye's rumble, zoom beats, abilities, lancers, champions, heraldry | builder-high | `src/audio/sfx*.ts`, `src/audio/synth/**` | 2.0, 2.1A beats | ✅ committed a77d602; review: accept with small fixes → fix round in flight (same agent) |

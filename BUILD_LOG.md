...
## Status
- **Now:** M1 First Blood. Done: 1.5 economy (255c39e), 1.7 SFX (01fc25a), 0.2 review fixes (78b041d). Running: 1.1 backdrop, 1.2 dragon, 1.3 crowd, 1.4 juice, 1.6 HUD, 1.8 writer, 1.9 sim; reviews of 1.5 and 1.7.
- **Next:** accept each track after review, then integration + art-direction passes, M1 review, playtest build.
...
| 2026-09-22 | Juice costs logic time (hit-stop/slow-mo scale the tick accumulator for a consistent freeze). Hit-stop ≤ 80 ms, crits/kills only, capped 0.12 s with a 0.3 s cooldown; `time.dilation` watch; the sim models the dilation. |
| 2026-09-22 | Audio key: D major pentatonic for coins, clangs and chimes (music in M2 should agree or modulate from it). |
...
| 1.5 Economy core: Decimal math, HP/gold, units, upgrades, milestones, crits, dragon phases | builder-high | ✅ committed, in review | src/core/** | 0.2 |
| 1.7 SFX v1 | builder-high | ✅ committed, in review | src/audio/** | 0.2 |
| 1.6 HUD, Army + Upgrades panels, title overlay, progressive disclosure | builder-medium | running | src/ui/** | 1.5 |
| 1.8 Meadow text: dragon names/epithets, unit + upgrade flavor, microcopy | writer | running | src/core/content/text*.ts | 1.5 |
| 1.9 Balance sim v0 (tier 0 pacing) | builder-high | running | src/sim/** | 1.5 |
...
- 2026-09-22: 0.2 review: no criticals; infra fixes committed (78b041d); core items folded into 1.5, post/grain items to 1.4.
- 2026-09-22: 1.5 economy landed (139 tests; engaged: first kill 1 s, archers ~55 s, 1/2.5/10 m at 1/2/3 min, 28 kills by 3:15). 1.7 SFX landed (metered offline; peak −8.5 dBFS live under load). 1.6, 1.8, 1.9 launched.
